...
Status = 0
Developers = Redis:sismember(TheMAX.."MAX:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheMAX.."MAX:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..ChatId,UserId) 
...
Status = Redis:get(TheMAX.."MAX:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheMAX.."MAX:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
return {
Lock     = '[Max 𝖲𝗈𝗎𝗋𝖼𝖾](https://t.me/ODKXXQ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[Max 𝖲𝗈𝗎𝗋𝖼𝖾](https://t.me/ODKXXQ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[Max 𝖲𝗈𝗎𝗋𝖼𝖾](https://t.me/ODKXXQ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[Max 𝖲𝗈𝗎𝗋𝖼𝖾](https://t.me/ODKXXQ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[Max 𝖲𝗈𝗎𝗋𝖼𝖾](https://t.me/ODKXXQ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[Max 𝖲𝗈𝗎𝗋𝖼𝖾](https://t.me/ODKXXQ)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
JoinChannel = true
local Channel = Redis:get(TheMAX..'MAX:Channel:Join')
if Channel then
...
elseif Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheMAX.."MAX:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheMAX.."MAX:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheMAX.."MAX:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
if Redis:get(TheMAX.."MAX:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheMAX.."MAX:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheMAX.."MAX:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheMAX.."MAX:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheMAX..'MAX:Channel:Join')}, },}}
...
if (Redis:get(TheMAX..'MAX:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheMAX..'MAX:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
Redis:set(TheMAX..'MAX:Channel:Join',ChannelUser) 
...
Redis:set(TheMAX..'MAX:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheMAX..'MAX:Channel:Join')
...
os.execute('rm -rf maxteam.lua')
download('https://raw.githubusercontent.com/MaxTeam2/TeamMax/main/maxteam.lua','maxteam.lua')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheMAX..'MAX:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheMAX..'MAX:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
end
Redis:del(TheMAX.."MAX:SendBcBot") 
...
Redis:set(TheMAX.."MAX:SendBcBot",true) 
...
Redis:set(TheMAX.."MAX:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheMAX.."MAX:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheMAX.."MAX:AddSudosNew"..msg_chat_id)
...
Redis:set(TheMAX.."MAX:AddSudosNew"..msg_chat_id,true)
...
Redis:set(TheMAX.."MAX:Set:Id:Group"..msg.chat_id,Text_Rand)
...
{{text =news,url = "https://t.me/ODKXXQ"}, },}}
...
if not Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheMAX.."MAX:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Developers:Groups",UserId) 
...
if not Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMAX.."MAX:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheMAX.."MAX:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Developers:Groups",UserId) 
...
if Redis:sismember(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheMAX.."MAX:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:del(TheMAX.."MAX:Developer:Bot:Reply"..msg.chat_id)
...
local Info_Members = Redis:smembers(TheMAX.."MAX:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheMAX.."MAX:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/ODKXXQ'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if not Redis:sismember(TheMAX.."MAX:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMAX.."MAX:ktmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMAX.."MAX:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not msg.ControllerBot and not Redis:set(TheMAX.."MAX:LeftBot") then
...
data = {
{
{text = '- قناة السورس', url = 't.me/ODKXXQ'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(TheMAX.."MAX:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
...
Rink = 1
elseif Redis:sismember(TheMAX.."MAX:Developers:Groups",UserId_Info.id)  then
Rink = 2
...
Redis:setex(TheMAX.."MAX:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
Redis:del(TheMAX.."MAX:Set:Id:Groups")
...
Redis:del(TheMAX.."MAX:DevelopersQ:Groups") 
...
Redis:del(TheMAX.."MAX:Developers:Groups") 
...
Redis:del(TheMAX.."MAX:TheBasicsQ:Group"..msg_chat_id) 
...
if not Redis:get(TheMAX.."MAX:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheMAX.."MAX:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TheMAX.."MAX:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
keyboard.inline_keyboard = {
{
{text = '𝖣𝖤𝖵𝖤𝖫𝖮𝖯𝖤𝖱 ', url = "https://t.me/YTTYB"},{text = 'Max 𝖲𝗈𝗎𝗋𝖼𝖾', url = "https://t.me/OXKXDQK"}
},
{
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if not Redis:get(TheMAX.."MAX:Sasa:Jeka"..msg_chat_id) then
...
if text == (Redis:get(TheMAX.."MAX:Name:Bot") or "ماكس") then
local NamesBot = (Redis:get(TheMAX.."MAX:Name:Bot") or "ماكس")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheMAX.."MAX:Name:Bot") or "ماكس")..
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheMAX.."MAX:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheMAX.."MAX:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheMAX.."MAX:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheMAX.."MAX1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheMAX.."MAX:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheMAX.."MAX:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMAX.."MAX:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMAX.."MAX1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMAX.."MAX:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMAX.."MAX:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:TheBasicsQ:Group"..ChatId) 
